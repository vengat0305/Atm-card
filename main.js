...
const mask = (value, limit, separator) => {
  ...
  highlightCC = (ccValue) => {
    ...
    changeCardLogo(
      ccCardType && ccCardType.length && ccCardType !== "genric"
        ? logoURL
        : DEFAULT_LOGO_URL
    );
  },
...
const ccExpiryInputKeyDownHandler = (e) => {
  ...
  changeCardExpiresDate = (value) => {
    ...
    document.getElementById("card-expires-date").innerHTML =
      formattedCode.join("/");
  };
...
const ccCVCSecretInputKeyDownHandler = (e) => {},
  changeCVCSecret = (value) => {
    document.getElementById("card-secret-cvc").innerHTML = value
      ? value
      : "***";
  },
